...
function(WinDeployQt)
  ...
  add_custom_target(windeployqt ALL ${_deploy_PROGRAM} --dir ${CMAKE_INSTALL_PREFIX} ${_ARGS}
	$<TARGET_FILE:${_deploy_TARGET}>
	DEPENDS ${_deploy_TARGET}
	COMMENT "Preparing Qt runtime dependencies")
  
  # add_custom_target(windeployqt POST_BUILD ${_deploy_PROGRAM} --dir ${PROJECT_BINARY_DIR}/windeployqt ${_ARGS}
  #   $<TARGET_FILE:${_deploy_TARGET}>
  #   DEPENDS ${_deploy_TARGET}
  #   COMMENT "Preparing Qt runtime dependencies")

  # install (DIRECTORY "${PROJECT_BINARY_DIR}/windeployqt/" DESTINATION ${CMAKE_INSTALL_PREFIX}")
endfunction()
